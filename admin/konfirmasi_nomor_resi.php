...
<script>
window.history.replaceState({}, document.title, "/" + "<?php echo $direktori_admin; ?>konfirmasi_nomor_resi.php?id_order=<?php echo $_GET['id_order']; ?>");
Swal.fire({
type: 'error',
...
<section class="order" id="keterangan_pemesanan">
    ...
    <div class="row">
        ...
        <form action='konfirmasi_nomor_resi_aksi.php' method="post" enctype="multipart/form-data" data-aos="fade-right">
        <input type="text" name="id_order" value="<?php echo $id_order; ?>">
            ...
            <input type="text" placeholder="No. Resi Pengiriman" name="no_resi_kurir" class="box" value="<?php echo $data_order['resi_kurir']; ?>"><br>
                  ...
                  <br><br>
                    ...
                    <button class="btn" type="submit">Konfirmasi Pengiriman / Kirim Nomor Resi</button>
